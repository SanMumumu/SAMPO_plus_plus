...
\textcolor{blue}{In this work, we presented SAMPO++, a unified continuous-flow world modeling framework that reconciles high-resolution scalability, interactive efficiency, and long-horizon spatiotemporal coherence. 
