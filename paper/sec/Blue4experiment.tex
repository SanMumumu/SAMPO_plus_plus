...
\textcolor{blue}{(1) Continuous Multi-Scale Tokenizer.
...
\textcolor{blue}{\textbf{Long-term Generation.}
\input{tab/vid_long}
...
\textcolor{blue}{\subsection{Generalization to Autonomous Driving}
\input{tab/vid_AD}
...
\begin{figure*}[t]
    ...
    \caption{\textcolor{blue}{\textbf{High-resolution long-term video prediction on OpenDV-YouTube dataset.} We visualize highly complex, in-the-wild driving scenarios. While SAMPO suffers from severe temporal degradation in unconstrained driving scenarios, SAMPO++ effectively maintains robust dynamic modeling and strongly resists visual artifacts.}}
    \label{fig_opendv}
    \vspace{-4ex}
\end{figure*}
